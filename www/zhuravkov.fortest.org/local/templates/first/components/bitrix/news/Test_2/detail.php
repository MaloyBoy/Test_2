...
<?endif?>
    ...
    $resNav = CIBlockElement::GetList(
        array(
            $arParams['NEWSSORT'] => $arParams['NEWSSORT'],
            $arParams['NEWSSORT'] => $arParams['NEWSSORT'],
        ),
        $arFilter,
        false,
    ...
    if (count($arNav) > 2) {
        ...
        echo "<a href=test_2.php?ELEMENT_ID=".$arResult['PREV']["ID"].">Предыдущая новость</a>";
        echo "<a href=test_2.php?ELEMENT_ID=".$arResult['NEXT']["ID"].">Следующая новость</a>";
    } else {
    ...
    if ($arResult = $res->GetNext())
        echo "<a href=test_2.php?ELEMENT_ID=".$arResult['ID'].">Предыдущая новость</a>";
    ...
    if ($arResult = $res->GetNext())
        echo "<a href=test_2.php?ELEMENT_ID=".$arResult['ID'].">Следующая новость</a>";*/
	?>
